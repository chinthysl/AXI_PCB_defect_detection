...
# solder_joint_container_obj.save_concat_images_first_four_slices_list_rgb_pickle()
# solder_joint_container_obj.save_concat_images_first_four_slices_2d_rotated_pickle()
# solder_joint_container_obj.save_concat_images_first_four_slices_2d_more_normal_pickle()
solder_joint_container_obj.save_concat_images_first_four_slices_list_more_normal_pickle()

# solder_joint_container_obj.save_4slices_individual_pickle()

# # print details of BoardView objects and SolderJoint objects
# solder_joint_container_obj.print_solder_joint_resolution_details()
